...
namespace WebProjesi.Controllers
{
    public class IletisimController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IletisimId,Adres,Telefon,Whatsapp,Facebook,Twitter,Instagram,Fax")] Iletisim iletisim)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IletisimId,Adres,Telefon,Whatsapp,Facebook,Twitter,Instagram,Fax")] Iletisim iletisim)
        {
            if (ModelState.IsValid)
            {
